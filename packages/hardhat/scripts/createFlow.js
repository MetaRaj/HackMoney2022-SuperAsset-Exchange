...
async function main() {
  ...
  //create contract instances for each of these. mine: creditclc contract instance to be created here
  ...
  async function startFlow() {
     ...
     .createFlow(
      ...
      "3858024691359", // minimal amount to initiate the credit checks, 10 DAI permonth
      "0x"
     )
     .encodeABI())
