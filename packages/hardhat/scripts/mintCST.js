...
// CHECK if address here is the same as git output after deployment????
...
const nameST = 'Asset Backed Super Token';
const symbolST = 'STAR'; //SuperToken with Asset Rights 
const stFac = '0x200657E2f123761662567A1744f9ACAe50dF47E6';



//initialize the custom super token
//will mint directly to the addres of the deployed TradeableCashFlow.sol after yarn deploy
async function main() {
  ...
  // could add userDataToken to diffentaite between different sets of minting???

  async function mintST() {
   
   let mintTx = (await mintableSuperToken.methods
     .mint(
