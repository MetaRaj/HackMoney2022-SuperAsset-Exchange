...
contract TradeableCashflow is ERC721, RedirectAll {   
  ...
  constructor (
    ...
    ISuperToken acceptedToken,  // payment token address
    ISuperToken assetToken // asset token address          
  )
...
// arguments passed in from front end
//Note: this is not used as calc done on App.jsx
function creditEval (int96 walletScore) external returns (int96 creditScore) {
      if  (walletScore <= 10)  creditScore = 50;
      else  creditScore = 75; 
}
